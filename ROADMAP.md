...
> 最后更新: 全部路线图 Phase 1-4 完成 + 后续增强 离线同步引擎 (v2.2.0) + 真实 OMR 识谱引擎 (v2.3.0) + OMR 节奏分析 (v2.4.0) + OMR 连梁组切分 (v2.5.0) + OMR 谱号/调号/拍号识别 (v2.6.0) + OMR 中音/次中音谱号识别 (v2.7.0) + OMR 附点音符识别 (v2.8.0) + OMR 符尾精细层数识别 (v2.9.0) + OMR 休止符识别 (v2.10.0)
